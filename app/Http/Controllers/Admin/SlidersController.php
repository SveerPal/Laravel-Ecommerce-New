...
class SlidersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $slider->heaading_first = $request->input('heaading_first');
        $slider->heaading_second = $request->input('heaading_second');
        $slider->heaading_third = $request->input('heaading_third');
        $slider->image = $image;
