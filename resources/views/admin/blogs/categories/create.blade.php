...
@section('content')
    ...
    <div class="row user">       
        <div class="col-md-12">
            <a href="{{ route('admin.blog-categories') }}" class="btn btn-primary text-white mr-1 mb-4" type="button">Back To Blog Category</a>
            <form action="{{ route('admin.blog-categories.store') }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <div class="tile">  
                    <div class="row">
