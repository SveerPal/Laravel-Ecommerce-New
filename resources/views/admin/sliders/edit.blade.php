                ...
                <div class="tile">  
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Heading First" id="heaading_first" name="heaading_first" value="{{ old('heaading_first', $sliderdtl->heaading_first) }}"/>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Heading Second" id="heaading_second" name="heaading_second" value="{{ old('heaading_second', $sliderdtl->heaading_second) }}"/>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Heading Third" id="heaading_third" name="heaading_third" value="{{ old('heaading_third', $sliderdtl->heaading_third) }}"/>
